...
public class Components {
    ...
    public static final String accounting1CInventoryNumberInputText = "accounting1CInventoryNumber";
    public static final String accounting1CTitleInputText = "accounting1CTitle";
    public static final String accounting1CEmployeeIdInputText = "employeeId";
