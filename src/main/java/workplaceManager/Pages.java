...
public class Pages {
    ...
    public static final String updateEmployeePost = "config/employee/updateEmployeePost";
    public static final String addEmployeePost = "config/employee/addEmployeePost";
    public static final String deleteEmployeePost = "config/employee/deleteEmployee";
    public static final String formConfigEmployee = "config/employee";
    ...
    public static final String formConfigAccounting1C = "config/accounting1c";
